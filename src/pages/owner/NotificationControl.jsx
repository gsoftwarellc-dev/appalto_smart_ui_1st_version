    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col gap-2">
                <h2 className="text-3xl font-bold tracking-tight text-gray-900">Notification Control</h2>
                <p className="text-gray-500">Manage email templates, system alerts, and messaging policies.</p>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-3">
                <Card className="col-span-2">
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2">
                            <Mail className="h-5 w-5 text-blue-600" /> Email Templates
                        </CardTitle>
                        <CardDescription>Configure automated email content.</CardDescription>
                    </CardHeader>
                    <CardContent>
                            ...
                            {templates.map((template) => (
                                <div key={template.id} className="flex items-center justify-between p-4 border rounded-lg hover:bg-gray-50 transition-colors">
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-xs text-gray-400">Last updated: {template.updated}</p>
                                    </div>
                ...
                <div className="space-y-6">
                    <Card>
                        <CardHeader>
                            <CardTitle className="flex items-center gap-2">
                                <Bell className="h-5 w-5 text-amber-600" /> System Alerts
                            </CardTitle>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            ...
                            <Separator />
                            <div className="flex items-center justify-between">
                                <span className="text-sm font-medium">New User Alerts</span>
                                <Button size="sm" variant="outline" className="text-green-600 border-green-200">Active</Button>
                            </div>
                            <Separator />
                            <div className="flex items-center justify-between">
                                <span className="text-sm font-medium">High Risk Tender Alerts</span>
                                <Button size="sm" variant="outline" className="text-green-600 border-green-200">Active</Button>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="bg-blue-50 border-blue-100">
                        <CardHeader>
                            <CardTitle className="text-sm font-medium text-blue-900">Email Service Status</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <div className="flex items-center gap-2 mb-2">
                                <div className="h-3 w-3 rounded-full bg-green-500 animate-pulse"></div>
                                <span className="font-bold text-blue-800">Operational</span>
                            </div>
